        ...
        <ol id="kc-totp-settings">
            <li>
                ...
                <ul id="kc-totp-supported-apps">
                    <li><a href="${msg('totpAppMicrosoftAuthenticatorUrl')}" target="_blank">${msg('totpAppMicrosoftAuthenticatorName')}</a></li>
                    <li><a href="${msg('totpAppTOTPAuthenticatorUrl')}" target="_blank">${msg('totpAppTOTPAuthenticatorName')}</a></li>
                    <li><a href="${msg('totpAppGooglePAuthenticatorUrl')}" target="_blank">${msg('totpAppGooglePAuthenticatorName')}</a></li>
                </ul>
            </li>
        ...
        <form action="${url.loginAction}" class="${properties.kcFormClass!}" id="kc-totp-settings-form" method="post">
            ...
            <#if isAppInitiatedAction??>
                <button type="submit"
                       ...
                       id="saveTOTPBtn" value="${msg("doSubmit")}">${msg("doSubmit")}
                </button>
                <button type="submit"
